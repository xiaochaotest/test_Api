...
#==============定义发送邮件==========
    def send_mail(self,file_new):
        ...
        port = 25   #端口
        username = '496650400@qq.com' #发件箱用户名
        password = 'imwyhbbunimjcahi'        #发件箱密码
        sender = '496650400@qq.com'   #发件人邮箱
        ...
        att["Content-Disposition"] = 'attachment; filename="test_ddou_report.html"'
        msg.attach(att)
        # ----------3.发送邮件------
        try:
            smtp = smtplib.SMTP()
